class Aarch64UnknownLinuxGnu < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/leostera/homebrew-macos-cross-toolchains/releases/download/v13.3.0/aarch64-unknown-linux-gnu-aarch64-darwin.tar.gz"
    sha256 "5092abd7f9f318672e833a8ad99a88d3d9044afc6e7152b26740d18b29949141"
  else
    url "https://github.com/leostera/homebrew-macos-cross-toolchains/releases/download/v13.3.0/aarch64-unknown-linux-gnu-x86_64-darwin.tar.gz"

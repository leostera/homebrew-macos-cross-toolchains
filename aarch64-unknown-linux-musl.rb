class Aarch64UnknownLinuxMusl < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/leostera/homebrew-macos-cross-toolchains/releases/download/v13.3.0/aarch64-unknown-linux-musl-aarch64-darwin.tar.gz"
    sha256 "7eee015d2536ccc2e8b263554d3477e16d1e9d78284bddcfe303db170b1bbea6"
  else
    url "https://github.com/leostera/homebrew-macos-cross-toolchains/releases/download/v13.3.0/aarch64-unknown-linux-musl-x86_64-darwin.tar.gz"

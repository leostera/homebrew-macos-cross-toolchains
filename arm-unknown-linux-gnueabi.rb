class ArmUnknownLinuxGnueabi < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/leostera/homebrew-macos-cross-toolchains/releases/download/v13.3.0/arm-unknown-linux-gnueabi-aarch64-darwin.tar.gz"
    sha256 "7167c4c5adffad5fc6681e4a810868251aba005bc8989f3e7a6d1ee0d4c9099b"
  else
    url "https://github.com/leostera/homebrew-macos-cross-toolchains/releases/download/v13.3.0/arm-unknown-linux-gnueabi-x86_64-darwin.tar.gz"

class ArmUnknownLinuxGnueabihf < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/leostera/homebrew-macos-cross-toolchains/releases/download/v13.3.0/arm-unknown-linux-gnueabihf-aarch64-darwin.tar.gz"
    sha256 "a233bd74dec09ccb00b9c3dea19f3fe0a7b7df5c43bb850ae2b5f1ab30466d46"
  else
    url "https://github.com/leostera/homebrew-macos-cross-toolchains/releases/download/v13.3.0/arm-unknown-linux-gnueabihf-x86_64-darwin.tar.gz"

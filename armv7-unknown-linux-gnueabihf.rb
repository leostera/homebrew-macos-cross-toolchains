class Armv7UnknownLinuxGnueabihf < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/leostera/homebrew-macos-cross-toolchains/releases/download/v13.3.0/armv7-unknown-linux-gnueabihf-aarch64-darwin.tar.gz"
    sha256 "b31019869d76f35c0e190a581c9a8bf0c7a117d1e8aa204e018ada9abd239a36"
  else
    url "https://github.com/leostera/homebrew-macos-cross-toolchains/releases/download/v13.3.0/armv7-unknown-linux-gnueabihf-x86_64-darwin.tar.gz"

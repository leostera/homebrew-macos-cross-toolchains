class Armv7UnknownLinuxMusleabihf < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/leostera/homebrew-macos-cross-toolchains/releases/download/v13.3.0/armv7-unknown-linux-musleabihf-aarch64-darwin.tar.gz"
    sha256 "92d9829dcd2bfa3fe895ae6a3c74436e5caf272dfafe406e17a090fd163feb38"
  else
    url "https://github.com/leostera/homebrew-macos-cross-toolchains/releases/download/v13.3.0/armv7-unknown-linux-musleabihf-x86_64-darwin.tar.gz"

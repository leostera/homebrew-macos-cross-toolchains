class I686UnknownLinuxGnu < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/leostera/homebrew-macos-cross-toolchains/releases/download/v13.3.0/i686-unknown-linux-gnu-aarch64-darwin.tar.gz"
    sha256 "2be86c0ccb93f8167ff50f851375e62792c600c6d3e6d4bf1619a65094e534c6"
  else
    url "https://github.com/leostera/homebrew-macos-cross-toolchains/releases/download/v13.3.0/i686-unknown-linux-gnu-x86_64-darwin.tar.gz"

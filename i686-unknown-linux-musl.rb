class I686UnknownLinuxMusl < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/leostera/homebrew-macos-cross-toolchains/releases/download/v13.3.0/i686-unknown-linux-musl-aarch64-darwin.tar.gz"
    sha256 "af39edc473382a0a1fa583ee28d21c2bf20c3aea55129e3a5bad3f614ba85019"
  else
    url "https://github.com/leostera/homebrew-macos-cross-toolchains/releases/download/v13.3.0/i686-unknown-linux-musl-x86_64-darwin.tar.gz"

class MipselUnknownLinuxGnu < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/leostera/homebrew-macos-cross-toolchains/releases/download/v13.4.0/mipsel-unknown-linux-gnu-aarch64-darwin.tar.gz"
    sha256 "b1a85172d6db74c210908ac1b8e636533c9ebaa4cf3a21e59b2b11c3a6ca11b8"
  else
    url "https://github.com/leostera/homebrew-macos-cross-toolchains/releases/download/v13.4.0/mipsel-unknown-linux-gnu-x86_64-darwin.tar.gz"

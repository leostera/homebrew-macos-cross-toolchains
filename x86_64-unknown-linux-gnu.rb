class X8664UnknownLinuxGnu < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/leostera/homebrew-macos-cross-toolchains/releases/download/v13.3.0/x86_64-unknown-linux-gnu-aarch64-darwin.tar.gz"
    sha256 "e0be7e6f753841450245e26b6d68a07dc6a48a74abdb36d44b118e799ff4cb8d"
  else
    url "https://github.com/leostera/homebrew-macos-cross-toolchains/releases/download/v13.3.0/x86_64-unknown-linux-gnu-x86_64-darwin.tar.gz"

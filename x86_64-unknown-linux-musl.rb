class X8664UnknownLinuxMusl < Formula
  ...
  if Hardware::CPU.arm?
    url "https://github.com/leostera/homebrew-macos-cross-toolchains/releases/download/v13.3.0/x86_64-unknown-linux-musl-aarch64-darwin.tar.gz"
    sha256 "9cb2ac32617fbc5812d411005d791cb10956be4f43efc1b14fa09030ce985f69"
  else
    url "https://github.com/leostera/homebrew-macos-cross-toolchains/releases/download/v13.3.0/x86_64-unknown-linux-musl-x86_64-darwin.tar.gz"
